...
type ComplexityRoot struct {
	...
	Query struct {
		Author func(childComplexity int, name *string) int
		Books  func(childComplexity int) int
	}
}

type QueryResolver interface {
	Author(ctx context.Context, name *string) (*model.Author, error)
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.author":
		...
		return e.complexity.Query.Author(childComplexity, args["name"].(*string)), true
...
var sources = []*ast.Source{
	{Name: "graph/schema.graphqls", Input: `type Author {
    id          : ID!
    name        : String!
    biography   : String!
    books       : [Book!]!
...
func (ec *executionContext) _Author_books(ctx context.Context, field graphql.CollectedField, obj *model.Author) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNBook2ᚕᚖbookinfoᚋgraphᚋmodelᚐBookᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Book_authors(ctx context.Context, field graphql.CollectedField, obj *model.Book) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNAuthor2ᚕᚖbookinfoᚋgraphᚋmodelᚐAuthorᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_author(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().Author(rctx, args["name"].(*string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	res := resTmp.(*model.Author)
	fc.Result = res
	return ec.marshalNAuthor2ᚖbookinfoᚋgraphᚋmodelᚐAuthor(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNAuthor2bookinfoᚋgraphᚋmodelᚐAuthor(ctx context.Context, sel ast.SelectionSet, v model.Author) graphql.Marshaler {
	return ec._Author(ctx, sel, &v)
}

func (ec *executionContext) marshalNAuthor2ᚕᚖbookinfoᚋgraphᚋmodelᚐAuthorᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Author) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNAuthor2ᚖbookinfoᚋgraphᚋmodelᚐAuthor(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNAuthor2ᚖbookinfoᚋgraphᚋmodelᚐAuthor(ctx context.Context, sel ast.SelectionSet, v *model.Author) graphql.Marshaler {
	if v == nil {
...
func (ec *executionContext) marshalNBook2ᚕᚖbookinfoᚋgraphᚋmodelᚐBookᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Book) graphql.Marshaler {
	ret := make(graphql.Array, len(v))
	var wg sync.WaitGroup
	isLen1 := len(v) == 1
	if !isLen1 {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNBook2ᚖbookinfoᚋgraphᚋmodelᚐBook(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNBook2ᚖbookinfoᚋgraphᚋmodelᚐBook(ctx context.Context, sel ast.SelectionSet, v *model.Book) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
